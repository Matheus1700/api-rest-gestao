...
describe('Testes da API de Filmes', () => {
    ...
    it('Deve listar todos os filmes (GET /api/filmes)', async () => {
    ...
    it('Deve remover um filme existente (DELETE /api/filmes/:id)', async () => {
    ...
    it('Deve retornar 404 ao tentar remover um filme inexistente (DELETE /api/filmes/:id)', async () => {
